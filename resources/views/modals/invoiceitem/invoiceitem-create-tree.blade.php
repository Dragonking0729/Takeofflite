<div class="modal fade" id="create_invoiceitem_treeview">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-around py-1">
                    <button type="button" title="Expand All" class="btn btn-outline-secondary btn-sm tree_expand"
                            onclick="$('#create_invoiceitem_tree').jstree('open_all');"></button>
                    <button type="button" title="Collapse All" class="btn btn-outline-secondary btn-sm tree_collapse"
                            onclick="$('#create_invoiceitem_tree').jstree('close_all');"></button>
                </div>
                <div id="create_invoiceitem_tree"></div>
            </div>

            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-success" id="create_invoiceitem_tree_ok">Ok</button>
            </div>
