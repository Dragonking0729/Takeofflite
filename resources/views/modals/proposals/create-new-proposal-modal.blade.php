<!-- create_new_proposal_modal -->
<div class="modal fade" id="create_new_proposal_modal">
            ...
            <form method="post" action="{{ route('proposal.store') }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="radio" class="col-sm-1 m-auto" name="create_from" id="create_new" value="create_new"
                            required checked>
                    ...
                    <div class="form-group row">
                        <label for="proposal_name" class="col-sm-4 my-auto">Proposal Name </label>
                        <input type="text" class="form-control col-sm-7" name="proposal_name" id="proposal_name"
                            required>
                    </div>
                </div>
