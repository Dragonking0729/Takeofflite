@section('custom_css')
    ...
    <script>document.write("<link rel='stylesheet' href='{{asset("css/proposals.css")}}?v=" + Date.now() + "'><\/link>");</script>
@endsection
...
<nav id="sidebar" class="border-right border-light mb-3 {{$is_sidebar_open ? '' : 'active'}}">
    ...
    <div id="proposal_item_list_panel">
        <div class="py-1">
