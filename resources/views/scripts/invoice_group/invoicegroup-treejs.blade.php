<script>
    function getInvoicegroupById(id) {
        someBlock.preloader();
        $.ajax({
            url: "{{ url('invoice_group/get_invoicegroup_by_id') }}",
            method: "POST",
            data: {
                _token: _token,
                page: id
            ...
            success: function(data) {
                ...
                $("#treeview").modal('hide');
                document.getElementById("add_invoicegroup_button").dataset.page=id;
            }
        });
    }
    ...
    $(document).on("click", ".open_folder", function() {
        someBlock.preloader();
        $.ajax({
            url: "{{ url('invoice_group/get_invoicegroup_tree') }}",
            method: "POST",
            data: {
                _token: _token
            },
